package com.xuhao.visualeffect.ui;
...
import com.xuhao.visualeffect.anim.ResetAnimation;
 ...
 * <p/>
 * description:自定义视觉误差Listview,重写overScrollBy
 * <p/>
 * Date: 2016/5/5  15:33
 */
public class MyListView extends ListView {
    ...
    public void setParallaxImage(ImageView mImage) {
        ...
        Log.d(TAG, "------\nheight: " + mOriginalHeight + " drawableHeight: " + drawableHeight + "\n------");
    }
    ...
    private void valueAnimator(final int startHeight, final int endHeight) {
        ...
        mValueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                Integer height = evaluate(fraction, startHeight, endHeight);
